...
parser.add_option("--st", dest="treatment_SAE", default=None,help = "HChub bed file of treatment group.")
parser.add_option("--sc", dest="control_SAE", default=None,help = "MChub bed file of control group.")
...
parser.add_option("--fs", dest="footprint_score", default=None,help = "Score threshold of footprint of treatment and control group. The footprint with score > set threshold would be used to caclulate footprint number in ATAC broad peak. Recommending minimum footprint score threshold for use in HChub identification of treatment and control group.")
...
import datetime
import os.path
log_file1=open(options.output_path+"/HChub_differential_analysis.log","a")
